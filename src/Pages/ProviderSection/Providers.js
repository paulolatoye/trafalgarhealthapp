        ...
        <div className="row">
            ...
            <div className="col-sm-12 col-md-12 col-lg-6">
                <div className="provider">
                    <h2 className='mb-4'>Leading healthcare <br/>providers</h2>
                    <Line />
                    <p className='mb-4'>
        ...
        <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-6">
                <div className="health">
                    <h2 className='mb-4'>Download our <br/>mobile apps</h2>
                    <Line />
                    <p className='mb-4'>
                        Our dedicated patient engagement app and <br/>web portal allow 
                        you to access information <br/>instantaneously (no tedeous form, long 
                        calls, <br/>or administrative hassle) and securely
                    </p>
